                            ...
                            <div class="row mb-3 g-3">
                                    ...
                                    <select name="admin_id" id="amdin_id" class="form-select">
                                        ...
                                        @foreach ($admins as $admin)
                                            <option value="{{ $admin->id }}"
                                                {{ $admin->id == $school->admin_id ? 'selected' : '' }}>{{ $admin->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                        value="{{ $school->name }}" placeholder="Name">
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="phone" class="form-control" id="phone"
                                        value="{{ $school->phone }}" placeholder="Phone">
                                </div>
                                <div class="col-6">
                                    <label for="address" class="form-label">Address</label>
                                    <input type="text" name="address" class="form-control" id="address"
                                        value="{{ $school->address }}" placeholder="Address">
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="number" name="service_charge" class="form-control" id="service_charge"
                                        value="{{ $school->service_charge }}" placeholder="Service Charge" value="0">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="install_fee" class="form-control" id="install_fee"
                                        value="{{ $school->install_fee }}" value="0">
                                </div>
                            </div>
                            <div class="row g-3">
